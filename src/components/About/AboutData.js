...
export const aboutData = [
  ...
  {
    id: 'Co-opbank Pertama Tawau',
    title: '// EXP: CO-OPBANK PERTAMA TAWAU',
    role: 'IT & Sales Representative Intern',
    date: 'Mar 2023 - Aug 2023',
    images: [
      {
        url: 'https://picsum.photos/seed/bank1/500/350',
        desc: 'Phase 1: IT Security & Maintenance. Supported the internal IT team in auditing network security protocols and maintaining core hardware within a secure banking environment.'
      },
      {
        url: 'https://picsum.photos/seed/bank2/500/350',
        desc: 'Phase 2: Client Relations & Marketing. Drove customer-centric outreach for Ar-Rahnu financial products and designed digital promotional assets.'
      }
    ]
  },
  {
    id: 'Thrift Clothing Sales',
    title: '// EXP: ENTREPRENEURSHIP',
    role: 'Thrift Clothing Sales',
