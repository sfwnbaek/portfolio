    ...
    import resumeFile from '../../assets/Resume_MuhammadSafwanRabe.pdf';
                    ...
                    <div className={styles.textContent}>
                        ...
                        <div className={`${styles.fadeInContent} ${nameDone ? styles.isVisible : ''}`}>
                            ...
                            <div className={styles.socialLinks}>
                                ...
                                <a href={resumeFile} download="Muhammad_Safwan_Rabe_Resume.pdf" className={`${styles.btn} ${styles.magneticBtn} ${styles.resumeBtn}`}>
